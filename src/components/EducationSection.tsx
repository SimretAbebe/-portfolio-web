...
const education = [
  ...
  },
  {
    ...
    institution: 'Bahir Dar American Corner',
    year: 'June - September 2022',
    focus: 'Exploring and building full stack web applications',
    achievements: ['Certificate of Appreciation', 'Bahir Dar, Ethiopia'],
  },
];
